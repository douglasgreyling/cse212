...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The underyling queue implementation was not using a queue which honored FIFO.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The queue was never handling turns less than or equal to zero as having infinite turns.
